...
class LocalModelDeployment(BaseDeployment):
    ...
    # def __init__(self, model_url: str, template: str = None):
    ...
    def invoke_chat_stream(self, chat_request: CohereChatRequest, **kwargs: Any) -> Any:
        ...
        #     messages=[
        #         {"role": "system", "content": "You are a helpful assistant or chatbot."},
    ...
    #     client = OpenAI(base_url=self.model_url, api_key="lm-studio")
    #     # model = Llama(
    #     #     model_path=self.model_path,
    #     #     verbose=False,
    #     # )
...
if __name__ == "__main__":
    # model = LocalModelDeployment(model_url="http://localhost:1234/v1")
    
    # path to model
    model = LocalModelDeployment(model_path="../../capybarahermes-2.5-mistral-7b.Q2_K.gguf")
